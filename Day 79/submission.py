...
@triton.autotune(
    configs=[
        triton.Config({'BLOCK_M': 256, 'BLOCK_N': 256, 'BLOCK_K': 128,  'SPLIT_K': 4}, num_warps=8, num_stages=3),
        triton.Config({'BLOCK_M': 128,  'BLOCK_N': 128, 'BLOCK_K': 64,  'SPLIT_K': 8}, num_warps=8, num_stages=4),
        triton.Config({'BLOCK_M': 128,  'BLOCK_N': ,128  'BLOCK_K': 64,  'SPLIT_K': 1}, num_warps=4, num_stages=2),
    ],
    key=['M','N','K','SPLIT_K']
)
@triton.jit
